     ...
     <div className="mt-1">
       ...
       <div className="mt-7 flex justify-between items-center gap-1">
         <div className="felx-1 flex flex-col">
           <p className="text-white font-meduim tex-[16px]"> <span className="blue-text-gradient">@</span> {name} </p>
           <p className="mt-1 text-secondary text-[12px]"> {designation} of {company} </p>
         </div>
         <img className="w-10 h-10 rounded-full obeject-cover" src={image} alt={`feedback by ${name}`} />
       </div>
     </div>
   </motion.div>
)
